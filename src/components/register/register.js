      ...
      firebase
        ...
        .then((createdUser) => {
         ...
         createdUser.user.updateProfile({
            ...
            photoURL: `https://api.adorable.io/avatars/100/${md5(this.state.email)}`
         })
         .then(()=> {
...
const inputErrorIndicator = (errors, inputNameField) => {
    return `form-control input-sm ${errors.some(error=>error.message.toLowerCase().includes(inputNameField))?'error': ''}`
}
